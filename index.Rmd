...
```{r}
#Annotating plot
barStackedAnnot = barStacked + geom_text(size = 4,#check below:
                             position = position_stack(vjust = 0.5),#center
                             aes(label=percent(Percent,accuracy = 0.1)))#percent format

barStackedAnnotate = barStackedAnnot + scale_y_continuous(labels = percent) + scale_fill_discrete(name="Race or Ethnicity")
...
barStackedLabel = barStackedAnnotate + labs(title = titleText,
                                         x = 'Role',
                                         y = 'Percent Across Washington Public School',
                                         caption = sourceText)
barStackedLabel
```
...
barStackedCent = barStackedLabel + theme(plot.caption = element_text(hjust = 0), 
